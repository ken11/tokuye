...
### Phase-Based Model Switching *(Beta)*

> ⚠️ **Beta feature**: This feature is experimental and may change in future releases.
...
- Cost tracking for the plan model requires that `bedrock_plan_model_id` contains one of the supported model name fragments (`claude-sonnet-4-6`, `claude-haiku-4-5`, `claude-opus-4-6`).
